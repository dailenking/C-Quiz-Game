...
int main()
    ...
    printf("\n\n\n\n\n\n\n\n\n\n\t\t\tResister your name:");
	 ...
	 /*
		Menu in which the user is informed that to proceed with the actual game, they must answer 2 questions
		and get 2/3 of the questions correct to proceed to the quiz game. 
	 */
...
game:
	 ...
	 /*
		User is asked many questions and as they answer more correctly, they get to advance to further rounds to get the 
		highscore. Upon answering questions correctly, their score is tracked as it gets higher.
	 */
	 ...
	 else
{
	...
	if (toupper(getch())=='Y')
		...
		goto mainhome;}}}
/*
Upon losing the player is shown their score, the highest score, and a chance to beat the highest
score by trying again
*/
...
// help menu when the user enters 'H' at the homescreen
void help()
	{system("cls");
    printf("\n\n                              HELP");
    printf("\n -------------------------------------------------------------------------");
